...
const EspaldaSchema = new Schema({
...
const Espalda = mongoose.model("espalda", EspaldaSchema);  // "" referencia del path despuest del 3000, y depués lo que lleva lo que he pedido
module.exports = Espalda; // exporto con su referencia completa 